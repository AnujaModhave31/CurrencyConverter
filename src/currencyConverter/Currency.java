	...
	public void defaultValues() {
		...
		switch (currency) {	
			...
			case "Euro":
				...
				this.exchangeValues.put("INR", 89.20);
				break;
			...
			case "British Pound":
				...
				this.exchangeValues.put("INR", 106.45);
				break;
			...
			case "Swiss Franc":
				...
				this.exchangeValues.put("INR", 83.00);
				break;
			...
			case "Chinese Yuan Renminbi":
				...
				this.exchangeValues.put("INR", 11.93);
				break;
			...
			case "Japanese Yen":
				...
				this.exchangeValues.put("INR", 0.67);
				break;
